...
<%
	...
	String sql="select mem_id,name,cancel_date from cancelledmember";
	int flag=0;
	if(start_date==""&&end_date=="")
		 response.sendRedirect("librarian.jsp?mem_cancel_stmt=Please choose atleast one of from Start date or end date");
...
%>
<p>Showing result from <%if(start_date!=""){%>
