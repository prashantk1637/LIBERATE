...
/**
 * Servlet implementation class GroupByBookCatlog
 */
@WebServlet("/SortByBookCatalog")
public class GroupByBookCatlog extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GroupByBookCatlog() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String sql="select path,title,author,edition,isbn,subject from books group by isbn";
