...
<div id="container">
		<div id="stdSearch">
				<h2>Book:&nbsp;Search</h2>
				<form action="stdSearch">
				<table>
					<tr>
						<td><input title="You can enter Title, Author or Keyword having Multi-text" class="field" id="search-input" type="text" name="search_query" placeholder="Title, Author, Keywords etc." required autocomplete="off"/></td>
					
					</tr>
					<tr>
						<td>
							<select name="search_by" style="width:100px;height:30px;border-radius:5px" required>
					...
					<tr>
					 ...
					 <tr>
					<td></td><td></td><td><a href="advanceSearch.jsp" style="color:black;font-size:18px;"><i>Advanced Search...</i></a></td><td></td><td></td><td><a href="isbnSearch.jsp" style="color:black;font-size:18px;"><i>ISBN Search...</i></a></td>
